...
if (IsSymb (_currn, SYMBFixLineParam)) return (Mkrule_09(_coordref, _currn));
if (IsSymb (_currn, SYMBGroupSpec)) return (Mkrule_010(_coordref, _currn));
if (IsSymb (_currn, SYMBPosition)) return (Mkrule_011(_coordref, _currn));
if (IsSymb (_currn, SYMBThreshold)) return (Mkrule_012(_coordref, _currn));
return(NULLNODEPTR);
}/* MkLineOpt */
...
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_46: root of subtree no. 2 can not be made a opt_ppm node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_46;
return ( (NODEPTR) _currn);
}/* Mkrule_46 */
...
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_47: root of subtree no. 2 can not be made a Frequency node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_47;
return ( (NODEPTR) _currn);
}/* Mkrule_47 */
...
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_48: root of subtree no. 2 can not be made a opt_tunerate node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_48;
return ( (NODEPTR) _currn);
}/* Mkrule_48 */
...
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_50: root of subtree no. 2 can not be made a opt_cm node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_50;
return ( (NODEPTR) _currn);
}/* Mkrule_50 */
...
_currn->_desc2 = (_TSPopt_cm) Mkopt_cm (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_51: root of subtree no. 2 can not be made a opt_cm node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_51;
return ( (NODEPTR) _currn);
}/* Mkrule_51 */
...
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_53: root of subtree no. 2 can not be made a opt_wn node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_53;
return ( (NODEPTR) _currn);
}/* Mkrule_53 */
...
_currn->_desc2 = (_TSPopt_wn) Mkopt_wn (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_55: root of subtree no. 2 can not be made a opt_wn node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_55;
return ( (NODEPTR) _currn);
}/* Mkrule_55 */
...
_currn->_desc2 = (_TSPopt_wn) Mkopt_wn (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_58: root of subtree no. 2 can not be made a opt_wn node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_58;
return ( (NODEPTR) _currn);
}/* Mkrule_58 */
...
_currn->_desc2 = (_TSPFloatVal) MkFloatVal (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_62: root of subtree no. 2 can not be made a FloatVal node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_62;
return ( (NODEPTR) _currn);
}/* Mkrule_62 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_64 (POSITION *_coordref, int _TERM1, NODEPTR _desc1)
#else
NODEPTR Mkrule_64 (_coordref, _TERM1,_desc1)
	POSITION *_coordref;
	int _TERM1;
	NODEPTR _desc1;
#endif
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_64: root of subtree no. 1 can not be made a opt_preserve node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_64;
#ifdef MONITOR
_currn->_uid=MONTblStackSize; MONTblStackPush(((NODEPTR)_currn));
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_65: root of subtree no. 1 can not be made a ScanNumRangeName node ", 0, _coordref);
_currn->_desc2 = (_TSPIntegerPair) MkIntegerPair (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_65: root of subtree no. 2 can not be made a IntegerPair node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_65;
return ( (NODEPTR) _currn);
}/* Mkrule_65 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_66: root of subtree no. 1 can not be made a IntegerPair node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_66;
return ( (NODEPTR) _currn);
}/* Mkrule_66 */
...
_currn->_desc1 = (_TSPIntegerPair) MkIntegerPair (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_67: root of subtree no. 1 can not be made a IntegerPair node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_67;
return ( (NODEPTR) _currn);
}/* Mkrule_67 */
...
_currn->_desc1 = (_TSPFloatVal) MkFloatVal (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_68: root of subtree no. 1 can not be made a FloatVal node ", 0, _coordref);
_currn->_desc2 = (_TSPopt_ppm) Mkopt_ppm (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_68: root of subtree no. 2 can not be made a opt_ppm node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_68;
return ( (NODEPTR) _currn);
}/* Mkrule_68 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_69 (POSITION *_coordref, int _TERM1, int _TERM2)
#else
NODEPTR Mkrule_69 (_coordref, _TERM1, _TERM2)
	POSITION *_coordref;
	int _TERM1;
	int _TERM2;
#endif
...
_currn->_desc1 = (_TSPFloatVal) MkFloatVal (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_70: root of subtree no. 1 can not be made a FloatVal node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_70;
return ( (NODEPTR) _currn);
}/* Mkrule_70 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_72 (POSITION *_coordref, int _TERM1)
#else
NODEPTR Mkrule_72 (_coordref, _TERM1)
	POSITION *_coordref;
	int _TERM1;
#endif
{	_TPPrule_72 _currn;
...
_currn->_desc1 = (_TSPPTE_opts) MkPTE_opts (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_028: root of subtree no. 1 can not be made a PTE_opts node ", 0, _coordref);
_currn->_desc2 = (_TSPPTE_opt) MkPTE_opt (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_028: root of subtree no. 2 can not be made a PTE_opt node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_028;
return ( (NODEPTR) _currn);
}/* Mkrule_028 */
...
#if defined(__STDC__) || defined(__cplusplus)
NODEPTR Mkrule_020 (POSITION *_coordref)
#else
NODEPTR Mkrule_020 (_coordref)
	POSITION *_coordref;
#endif
{	_TPPrule_020 _currn;
#ifdef __cplusplus
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_014: root of subtree no. 1 can not be made a LineOpts node ", 0, _coordref);
_currn->_desc2 = (_TSPLineOpt) MkLineOpt (_coordref, _desc2);	
if (((NODEPTR)_currn->_desc2) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_014: root of subtree no. 2 can not be made a LineOpt node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_014;
return ( (NODEPTR) _currn);
}/* Mkrule_014 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_012: root of subtree no. 1 can not be made a Threshold node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_012;
return ( (NODEPTR) _currn);
}/* Mkrule_012 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_011: root of subtree no. 1 can not be made a Position node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_011;
return ( (NODEPTR) _currn);
}/* Mkrule_011 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_010: root of subtree no. 1 can not be made a GroupSpec node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_010;
return ( (NODEPTR) _currn);
}/* Mkrule_010 */
...
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_09: root of subtree no. 1 can not be made a FixLineParam node ", 0, _coordref);
_COPYCOORD(_currn)
_TERMACT_rule_09;
return ( (NODEPTR) _currn);
}/* Mkrule_09 */
...
_currn->_desc1 = (_TSPLines) MkLines (_coordref, _desc1);	
if (((NODEPTR)_currn->_desc1) == NULLNODEPTR)	
	message (DEADLY, "RULE rule_08: root of subtree no. 1 can not be made a Lines node ", 0, _coordref);
_SETCOORD(_currn)
_TERMACT_rule_08;
return ( (NODEPTR) _currn);
}/* Mkrule_08 */
