...
int ShowVersion = 0;
DefTableKey RestartAt = NoKey;
static int RestartAt_count = 0;
...
static opt opts[] = {
    ...
    { "-V", BOOL , &ShowVersion, NULL, NULL },
    { "--Version", BOOL , &ShowVersion, NULL, NULL },
    { "--version", BOOL , &ShowVersion, NULL, NULL },
    { "--RestartAt", INTVAL | SPACED, &RestartAt_count, &RestartAt, NULL },
...
#endif
{
  ...
  fprintf (stderr, "    -V             Display icosfit version and exit\n");
  fprintf (stderr, "    --Version      Display icosfit version and exit\n");
  fprintf (stderr, "    --version      Display icosfit version and exit\n");
  fprintf (stderr, "    --RestartAt int Index number at which to restart fit\n");
