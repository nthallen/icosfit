...
extern NODEPTR Mkopt_coadd ELI_ARG((POSITION *_coordref, NODEPTR _currn));
...
extern NODEPTR Mkrule_73 ELI_ARG((POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2));
...
extern NODEPTR Mkrule_77 ELI_ARG((POSITION *_coordref, int _TERM1, int _TERM2));
