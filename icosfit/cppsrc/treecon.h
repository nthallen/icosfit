...
extern NODEPTR Mkrule_45 ELI_ARG((POSITION *_coordref, int _TERM1));
...
extern NODEPTR Mkrule_60 ELI_ARG((POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2));
...
extern NODEPTR Mkrule_64 ELI_ARG((POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2));
...
extern NODEPTR Mkrule_71 ELI_ARG((POSITION *_coordref, int _TERM1, NODEPTR _desc1));
...
extern NODEPTR Mkrule_76 ELI_ARG((POSITION *_coordref, int _TERM1, int _TERM2));
extern NODEPTR Mkrule_77 ELI_ARG((POSITION *_coordref, NODEPTR _desc1));
extern NODEPTR Mkrule_78 ELI_ARG((POSITION *_coordref, int _TERM1));
extern NODEPTR Mkrule_79 ELI_ARG((POSITION *_coordref, int _TERM1));
extern NODEPTR Mkrule_030 ELI_ARG((POSITION *_coordref));
extern NODEPTR Mkrule_029 ELI_ARG((POSITION *_coordref));
extern NODEPTR Mkrule_028 ELI_ARG((POSITION *_coordref));
extern NODEPTR Mkrule_027 ELI_ARG((POSITION *_coordref));
extern NODEPTR Mkrule_026 ELI_ARG((POSITION *_coordref));
...
extern NODEPTR Mkrule_020 ELI_ARG((POSITION *_coordref, int _TERM1));
extern NODEPTR Mkrule_019 ELI_ARG((POSITION *_coordref, int _TERM1));
extern NODEPTR Mkrule_018 ELI_ARG((POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2));
...
extern NODEPTR Mkrule_012 ELI_ARG((POSITION *_coordref));
