...
extern NODEPTR Mkrule_69 ELI_ARG((POSITION *_coordref, int _TERM1, NODEPTR _desc1));
extern NODEPTR Mkrule_70 ELI_ARG((POSITION *_coordref, NODEPTR _desc1, NODEPTR _desc2));
...
extern NODEPTR Mkrule_74 ELI_ARG((POSITION *_coordref, int _TERM1, int _TERM2));
...
extern NODEPTR Mkrule_77 ELI_ARG((POSITION *_coordref, int _TERM1));
